...
## Download 
Download [Sales Layer Magento 2 extension 2.5.9](https://github.com/saleslayer/magento-community-plugin/releases/download/2.5.9/magento-community-plugin.zip) compatible with Magento Open Source from versions 2.1.4 up to 2.4.0
...
|----------------|-------------------------------|---------|------------|
| [2.5.0][2.5.0] |  Magento Open Source 2.4.0    | PHP 7.3 | Apache2.4  |
| [2.5.1][2.5.1] |  Magento Open Source 2.4.0    | PHP 7.3 | Apache2.4  |
| [2.5.2][2.5.2] |  Magento Open Source 2.4.0    | PHP 7.3 | Apache2.4  |
| [2.5.3][2.5.3] |  Magento Open Source 2.4.0    | PHP 7.3 | Apache2.4  |
| [2.5.4][2.5.4] |  Magento Open Source 2.4.0    | PHP 7.3 | Apache2.4  |
| [2.5.5][2.5.5] |  Magento Open Source 2.4.0    | PHP 7.3 | Apache2.4  |
| [2.5.6][2.5.6] |  Magento Open Source 2.4.0    | PHP 7.3 | Apache2.4  |
| [2.5.7][2.5.7] |  Magento Open Source 2.4.0    | PHP 7.3 | Apache2.4  |
| [2.5.8][2.5.8] |  Magento Open Source 2.4.0    | PHP 7.3 | Apache2.4  |
| [2.5.9][2.5.9] |  Magento Open Source 2.4.0    | PHP 7.3 | Apache2.4  |
...
[2.5.0]:https://github.com/saleslayer/magento-community-plugin/releases/tag/2.5.0
[2.5.1]:https://github.com/saleslayer/magento-community-plugin/releases/tag/2.5.1
[2.5.2]:https://github.com/saleslayer/magento-community-plugin/releases/tag/2.5.2
[2.5.3]:https://github.com/saleslayer/magento-community-plugin/releases/tag/2.5.3
[2.5.4]:https://github.com/saleslayer/magento-community-plugin/releases/tag/2.5.4
[2.5.5]:https://github.com/saleslayer/magento-community-plugin/releases/tag/2.5.5
[2.5.6]:https://github.com/saleslayer/magento-community-plugin/releases/tag/2.5.6
[2.5.7]:https://github.com/saleslayer/magento-community-plugin/releases/tag/2.5.7
[2.5.8]:https://github.com/saleslayer/magento-community-plugin/releases/tag/2.5.8
[2.5.9]:https://github.com/saleslayer/magento-community-plugin/releases/tag/2.5.9
